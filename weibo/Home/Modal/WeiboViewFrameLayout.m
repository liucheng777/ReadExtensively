...
- (void)_layoutFrames{
    ...
    CGFloat textHeight = [WXLabel getTextHeight:weiboFontSize width:textWidth text:text linespace:5];
    ...
    if (self.model.reWeiboModel != nil) {
        ...
        //2>高度
        CGFloat reTextHeight = [WXLabel getTextHeight:reWeiboFontSize width:reTextWidth text:reText linespace:5];
        //3>Y坐标
